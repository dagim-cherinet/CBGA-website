  ...
  return (
    ...
    >
      <div className="grid md:grid-cols-2 max-w-[1240px] m-auto">
        <div className=" flex flex-col justify-center md:items-start w-full px-2 py-24 sm:py-8">
          {/* <p
          ...
          <h1 className="py-3 text-4xl md:text-7xl font-bold">E-Learning</h1>
          <p className="text-2xl">Check our e-learning platform</p>
          <button className="py-3 px-6 sm:w-[60%] my-4 sm:text-2xl">
            Get Started
          </button>
        </div>
        <div>
